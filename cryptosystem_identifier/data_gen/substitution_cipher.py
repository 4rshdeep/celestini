...
#     myMessage = "IF YOU WOULD LIKE TO SOLVE AN IMPORTANT SOCIAL PROBLEM WHILE WORKING WITH THE LATEST TECHNOLOGY AND LEARNING FROM INCREDIBLE MENTORS WE HAVE A PROJECT FOR YOU THIS PROJECT CALLED CELESTINI PROJECT HAS"
#     myKey = 'KEY'
#     myMode = 'encrypt'  # set to 'encrypt' or 'decrypt'
